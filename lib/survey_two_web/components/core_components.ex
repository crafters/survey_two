defmodule SurveyTwoWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SurveyTwoWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SurveyTwoWeb.Gettext, "errors", msg, opts)
    end
  end
